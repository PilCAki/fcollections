...
def random_tests():
    ...
    print(a.map(lambda x:x//2))  # Integer division for Python 3
    print(a.reduce(lambda a,b:a+b))
    print(a.partition(5).concat())  # Added parentheses for method call
    print(a.first(), a.second(), a.last())  # Added parentheses for method call
    print(a.diff(b))
    print(a.groupby(is_even))
    print(a.interleave(b))
    print(a.interpose('99'))
    print(a.is_distinct())  # Added parentheses for method call
    print(c.mapcat(lambda x:x*2))
    print(a.nth(2))
    print(a.partition(3))
    print(a.partition_all(3))
    print(a.peek())  # Added parentheses for method call
    print(c.pluck(4))
    print(a.reduce_by(is_even, lambda a,b:a*b))
    print(a.remove(is_even))
    print(a.sliding_window(4).to_list())  # Added parentheses for method call
    print(a.take(5))
    print(a.tail(5))
    print(a.stride_by(3))
    print(a.top_k(4))
